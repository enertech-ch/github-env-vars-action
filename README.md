...
| `CI_PRIMARY_REF_NAME`      | For PRs: `CI_HEAD_REF_NAME`. <br> Otherwise: `CI_REF_NAME`                                                                                                     | `feat/feature-branch-1` or<br> `v1.3.7` or<br> `42/merge` |
| `CI_PRIMARY_REF_SLUG`      | Similar to `CI_PRIMARY_REF_NAME`, but as slug                                                                                                                  | `feat-feature-branch-1` or<br> `v1-3-7` or<br> `42-merge` |   
| `CI_PRIMARY_SHA`           | For PRs: `pull_request.head.sha` <br> Otherwise: `CI_SHA`                                                                                                      | `ffac537e6cbbf934b08745a378932722df287a53` |
